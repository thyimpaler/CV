        ...
        {stats.map((stat, i) => (
          <RevealOnScroll key={stat.label} className="bg-[var(--background)]">
            ...
            >
              ...
              <span className="mt-6 block font-[family-name:var(--font-display)] text-[clamp(46px,6vw,86px)] leading-[0.9] tracking-[-0.04em] text-[var(--ink-strong)] transition-colors duration-700 group-hover:text-[var(--brand-gold)]">
                {stat.value}
              </span>
